...
public class AnalysisHistoryIntegrationTest {
    ...
    @Test
    public void testRunAnalysis_Success() {
        given()
                .auth().oauth2(token)
        .when()
                .post("/api/analysis/run/1")
        .then()
                .statusCode(201)
                .body("content.calculatedScore", notNullValue())
                .body("content.repositoryId", is(1))
                .body("content.repositoryName", is("snippet-vault"));
    }
    ...
    @Test
    public void testRunAnalysis_Unauthorized() {
        given()
                .auth().none()
        .when()
                .post("/api/analysis/run/1")
    ...
    @Test
    public void testGetHistory_Unauthorized() {
        given()
                .auth().none()
        .when()
                .get("/api/analysis/history")
